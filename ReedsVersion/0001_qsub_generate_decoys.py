...
def write_qsub(smiles_directory, curltype):
	...
	if curltype.lower() == "smiles":
		#output.write("python /mnt/nfs/ex9/work/stefan/Covid-19/20210804_Mpro_CUBS/decoys_larger_SMILES/test-code/generate_decoys_with_SMILES.py "+smiles_directory+"ligand_${SGE_TASK_ID}/ligand_${SGE_TASK_ID}.smi \n")
